...
// func TestAccNetworkSecurityPerimeterResourceAssociation_complete(t *testing.T) {
// 	data := acceptance.BuildTestData(t, "azurerm_network_security_perimeter_association", "test")
// 	r := NetworkSecurityPerimeterAssociationTestResource{}
...
// func TestAccNetworkSecurityPerimeterResourceAssociation_update(t *testing.T) {
// 	data := acceptance.BuildTestData(t, "azurerm_network_security_perimeter_association", "test")
// 	r := NetworkSecurityPerimeterAssociationTestResource{}
